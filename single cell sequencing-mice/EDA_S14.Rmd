...
```{r import data}
# input data
pbmc.data <- Read10X(data.dir="./S14/filtered_feature_bc_matrix/")
...
```{r QC plot1}
pdf(file="mice_S14_plot/QC_plot.pdf",width=18,height=9)
...
pdf(file="mice_S14_plot/top10var_plot.pdf",width=18,height=9)
plot1
plot2
plot1+plot2
dev.off()
...
pdf(file="mice_S14_plot/pc_plot.pdf",width=18,height=9)
...
pbmc <- FindNeighbors(pbmc, dims = 1:10,k.param = 20,n.trees = 100)
pbmc <- FindClusters(pbmc, resolution = 0.4,n.iter = 10000,n.start = 100)
```


```{r tnse plot}
# UMAP plot
pdf(file="mice_S14_plot/cluster_plot.pdf",width=18,height=9)
