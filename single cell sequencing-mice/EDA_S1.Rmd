...
```{r import data}
# input data
pbmc.data <- Read10X(data.dir="./S1/filtered_feature_bc_matrix/")
...
```{r QC plot1}
pdf(file="mice_S1_plot/QC_plot.pdf",width=18,height=9)
...
pdf(file="mice_S1_plot/top10var_plot.pdf",width=18,height=9)
plot1
plot2
plot1+plot2
dev.off()
...
pdf(file="mice_S1_plot/pc_plot.pdf",width=18,height=9)
...
```{r tnse plot}
# TSNE plot
pdf(file="mice_S1_plot/cluster_plot.pdf",width=18,height=9)
